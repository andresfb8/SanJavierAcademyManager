                ...
                {loading ? (
                    ...
                    <div className="divide-y divide-gray-200">
                        {filteredParameters.map((param) => (
                            <div key={param.id} className="p-4 hover:bg-gray-50 transition-colors flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                                ...
                                <div className="flex items-center gap-3 shrink-0">
                                    ...
                                    <div className="flex items-center gap-2 border-r border-gray-200 pr-3 mr-1">
                                        {param.videoUrl ? (
                                            <a href={param.videoUrl} target="_blank" rel="noopener noreferrer" className="p-1.5 text-red-500 hover:bg-red-50 rounded-md transition-colors" title="Ver Video">
                                                {param.videoUrl.includes('youtube.com') || param.videoUrl.includes('youtu.be') ? <Youtube className="w-5 h-5" /> : <Video className="w-5 h-5" />}
                                            </a>
                                        ) : (
                                            <div className="w-8"></div> // Spacer to keep alignment
                                        )}
                                        {param.documentUrl ? (
                                            <a href={param.documentUrl} target="_blank" rel="noopener noreferrer" className="p-1.5 text-blue-500 hover:bg-blue-50 rounded-md transition-colors" title="Ver Documento">
