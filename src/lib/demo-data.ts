...
export const demoCoachSalaryConfigs: CoachSalaryConfig[] = [
  {
    coachId: 'coach-001',
    ratePerGroupAdults: 250,
    ratePerGroupMinors: 200,
    privateLessonPaymentType: 'percentage',
    privateLessonRate: 50,
  ...
  {
    coachId: 'coach-002',
    ratePerGroupAdults: 200,
    ratePerGroupMinors: 150,
    privateLessonPaymentType: 'fixed',
    privateLessonRate: 20,
    eventPaymentType: 'percentage',
    eventRate: 50,
    bonuses: 50,
  },
